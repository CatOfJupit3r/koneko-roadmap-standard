...
description: >
  Create new Koneko roadmaps from rough ideas, research notes, feature requests,
...
Create Koneko roadmaps that are concise, source-backed, agent-executable, and ready to become the repository's source of truth.
...
- `Research-to-roadmap`: turn research into Koneko-specific decisions without pasting the research dump into the roadmap.
...
Use non-goals aggressively. Koneko roadmaps benefit from explicit no-gos such as:
